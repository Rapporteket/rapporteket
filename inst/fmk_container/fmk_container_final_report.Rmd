...
abstract: Fra Teknologiforum for medisinske kvalitetsregistre (FMK) søkes det om kr
  401 920 som delfinansiering av aktivitet for ferdigstillelse av Rapporteket som
  applikasjonscontainer. Arbeidsoppgavene vil være knyttet til definisjon og valg
  av arkitektur, teknologi og metodikk der målet er å etablere et system for kontinuerlig
  integrasjon og leveranse av resultattjenester. Målet vil være nådd når et eksisterende
  register på dagens utgave av Rapporteket kan demonstreres i full skala som en applikasjonscontainer
