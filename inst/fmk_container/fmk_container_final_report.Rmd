...
I prosjektsøknaden ble følgende oppgaver pekt på som sentrale for nå målet for prosjektet:

* Teknisk arkitektur,
* Tilrettelegging for kontinuerlig integrasjon og leveranse (ci/cd),
* PKCE-flow for ShinyProxy, og
* Rapporteket claims i Falk

Alle resultater fra prosjektet er gitt under.
