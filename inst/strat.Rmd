...
## Organisering
Dataansvaret (_i.e._ eierskapet) til de nasjonale kvalitetsregistrene er i de fleste tilfeller knyttet til de ulike helseforetakene og det er således i praksis ingen mulighet for enhetlig styring. Helse og omsrogsdepartementet finansierer nasjonalt servicemiljø som med all gode intensjoner samordner felles nasjonale fora til det beste for alle og verdensfreden forøvrig. Mot slutten av dagen er det uansett hver enkelt dataansvarlig som bestemmer noe som i best fall gir spredt orden[^3]. Som for mange andre områder så vil også ønsket utvikling for Rapportekt (hva den nå enn måtte være) begrenses av manglende evne til enhetlig styring.

[^3]: millitær sjargong; motsatt av sluttet orden

## Kompetanse: kvalitet og kvantitet

## Teknologi
Rapporteket har etter nylig gjennomført modernisering egentlig ingen begrensninger som kan tilskrives teknologi som skal understøtte formålet. Det som kan gi utfordringer er å holde tritt med den generelt raske utviklingstakt i relevante digitale verktøy.

## Uvilje, furting, udugelighet, eller noe sånt...
Dataleveranser til Rapporteket fra MRS-baserte registre har siden starten vært av svært dårlig kvalitet og slik er det fortsatt. Resultattjenester på Rapporteket for registrene dette gjelder har derfor vært beheftet med mange feil og lange perioder med manglende oppdatering av data. Av alle ting er det å levere data til Rapporteket teknisk sett ukomplisert men det har altså vist seg nokså umulig å ta knekken på problemet. Siden dette har vært situasjonen over mange år har det også festet seg et inntrykk av at Rapporteket ikke er egnet som resultattjeneste for registre som benytter MRS for registrering av data. Og de som jobber med Rapporteket gråter blod...
