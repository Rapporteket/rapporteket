...
## Organisering
Dataansvaret (_i.e._ eierskapet) til de nasjonale kvalitetsregistrene er i de fleste tilfeller knyttet til de ulike helseforetakene. Nasjonal styring av kvalitetsregisterfeltet skjer gjennom koordinerte formuleringer i oppdragsdokumentene som årlig går ut til helseforetakene. Helse og omsorgsdepartementet finansierer nasjonalt servicemiljø som gjennom ulike nasjonale fora operasjonaliserer oppdragene ved å definere felles mål og tiltak for de nasjonale kvalitetsregistrene. Et slikt tiltak kan være at de nasjonale kvalitetsregistrene benytter en resultattjeneste som Rapporteket eller tilsvarende og som kan stimuleres eksempelvis gjennom ordningen for stadieinndeling av de nasjonale kvalitetsregistrene. Følgelig stilles det ikke krav til bruk av Rapporteket eller tilsvarende resultattjenester og det er i prakis opp til hvert enkelt register selv å bestemme om man ønsker å benytte denne resultattjenesten.
