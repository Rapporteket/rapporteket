...
Hovedutfordring for større utbredelse av Rapporteket er begrensning i kapasitet og delvis kompetanse hos statistikere og analysemedarbeidere som jobber med registerdata. Det har over mange år vært en ambisjon å ansette nok folk med riktig kompetansen i servicemiljøene. Dette har man delvis klart i regionene Nord, Vest og Midt mens Sør-Øst i praksis står uten denne kapasiteten. De registrene som fungerer på Rapporteket idag har enten ansatt egne folk med riktig kompetanse i registeret eller det er registre som får kompetansebehovet dekket av statistikere ved SKDE.
