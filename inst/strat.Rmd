...
Samlet sett tilhører de nasjonale kvalitetsregistrene forskjellige styringslinjer i mange adskilte organisasjoner. Nasjonalt servicemiljø er satt til å koordinere feltet nasjonalt, men gitt underliggene organisering er det ikke mulig med direkte operasjonell styring. De fleste endringer og tiltak vil derfor være basert på konsensuns blant aktørene. For Rapporteket betyr dette at registrene selv velger om- og i hvilket omfang de ønsker å benytte resultattjenesten.
