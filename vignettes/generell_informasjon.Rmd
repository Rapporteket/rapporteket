...
## Bestilling
Hvis du ønsker å bestille Rapporteket for ditt register er første steg å ta kontakt med Nasjonale Servicemiljø eller Servicemiljøet i din region.
Servicemiljøet vil bistå registeret med videre bestilling.
Spørsmål kan også rettes til rapporteket@skde.no. 

For å kunne jobbe med et register, er det viktig at det finnes en detaljert variabeldokumentasjon av alle variable i registeret, og at registeret kan formidle hva de ønsker å finne på Rapporteket for det aktuelle registeret.
Dette innebærer å spesifisere hvilke type figurer og tabeller man ønsker, samt hvilke variable som skal visualiseres.
...
Vi vil være behjelpelige med å komme fram endelig utforming av figurer, tabeller og rapporter.
...
En bestilling av Rapporteket må minst inneholde følgende informasjon:
