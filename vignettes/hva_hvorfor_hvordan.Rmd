...
Når man bruker tid på å registrere data, er det viktig å kunne få noe tilbake i form av oppdaterte resultater. Alle avdelinger som registrerer vil kunne gå inn på Rapporteket å se på sine resultater. Registeret definerer selv hva det skal være mulighet for å se på sitt Rapportek og hvem som skal ha det. Man kan også velge å vise ulike deler av Rapporteket til personer med ulike roller.
...
en midlertidig løsning på plass. Fra andre innregistreringsløsninger (e-Reg)
