...
To ensure that changes to Rapporteket can be delivered in a timely and reliable manner speciffic workflows are adopted. These pipelines for both the base image and registry applications are illustrated below.

![alt img](../inst/base_image.png)
...
As all code repositories are managed at GitHub, [Github Actions]() are used to implement the CI/CD policy and are triggered both on a schedule and on code update requests.
